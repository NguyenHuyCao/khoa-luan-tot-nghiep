          ...
          <div class="row">
            <div class="col-md-6 col-sm-4">
              <div class="left-header clearfix">
                <ul>
                  <li><p><i class="fa fa-phone" aria-hidden="true"></i>(+84) 8888 99998</p></li>
              ...
              <div class="right-header ">
                <ul>
                  ...
                  if(isset($_COOKIE['username'])) {
                    $user_admin = $_COOKIE['username'];

                    // Lấy thông tin người dùng từ cơ sở dữ liệu
                    $query = "SELECT * FROM user WHERE username='$user_admin'";
                    $result = mysqli_query($mysqli, $query);

                    if ($result && mysqli_num_rows($result) > 0) {
                      $user = mysqli_fetch_assoc($result);

                      echo '<li><a style="color:#00FFFF; font-weight: 500; text-transform: uppercase;" href=""><i class="fas fa-star" style="color: #f6fa05;"></i>' . $_COOKIE['username'] . '</a>
                        <ul><div class="logout">';
                      if ($user['role'] == 'admin') {
                        echo '
                  ...
                  <nav>
                    <ul>
                      ...
                      <li><a href="#">Cửa hàng</a>
                        ...
                        <li><a href="#">Tin Tức</a>
                          <ul>
                            <li><a href="blog_1.php">Bàn Ghế - Khám Phá Sự Tinh Tế Tại Luxury Home</a></li>
                            <li><a href="blog_2.php">Nội Thất Cao Cấp - Khám Phá Vẻ Đẹp Sang Trọng Tại Luxury Home</a></li>
                            <li><a href="blog_3.php">Bàn Ăn - Sự Sang Trọng Tại Luxury Home</a></li>
                          </ul>
                        </li>
                  ...
                  <ul>
                    <li class="re-icon tnm"><i class="fa fa-search" aria-hidden="true"></i>
                      <form action="shop.php" method="GET" id="searchform">
                        <input type="text" value="" name="search" id="ws" placeholder="Tìm kiếm sản phẩm..." />
                      ...
                      <ul class="drop-cart">
                        ...
                        ?>
                          <li class="total-amount clearfix">
                            <span class="floatleft">Tổng cộng</span>
                            <span class="floatright"><strong><?= number_format($total, 0, ',', '.') ?><span> VNĐ</span></strong></span>
                          </li>
                          <li>
                            <div class="goto text-center">
                              <a href="shopping-cart.php"><strong>Đi đến giỏ hàng &nbsp;<i class="pe-7s-angle-right"></i></strong></a>
                            </div>
                          </li>
                          <li class="checkout-btn text-center">
                            <a href="checkout_product.php">Thanh toán</a>
                          </li>
                        </ul> 
                    </li>
                  </ul>
