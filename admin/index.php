...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
        ...
        <div class="row align-items-center">
          <div class="col-sm-6 col-12 mb-4 mb-sm-0">
            ...
            <h1 class="h2 mb-4 ls-tight">
              <!-- <img src="/Web/images/logo1.png" width="60"> -->
               <!-- Luxury Home -->
                QUẢN LÝ LIÊN HỆ
            </h1>
          </div>
      ...
      <div class="container-fluid">
        ...
        <div class="card shadow border-0 mb-7" style="padding: 20px">
          <div class="card-header">
            <h5 class="mb-0">DANH SÁCH LIÊN HỆ MỚI</h5>
          </div>
                      ...
                      foreach ($contact_List as $item) {
                        echo '
                          <tr>
                            ...
                            <td>
                              <a href="delete_contact.php?id=' . $item['id'] . '" class="delete-contact">
  ...
  <script>
    // Xác nhận xóa
    document.querySelectorAll('.delete-contact').forEach(function(link) {
    ...
    <?php if (isset($_GET['delete_success']) && $_GET['delete_success'] == 'true'): ?>
        Swal.fire({
            ...
            // Xóa tham số delete_success khỏi URL để không hiển thị lại thông báo khi tải lại trang
